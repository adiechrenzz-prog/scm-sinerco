...
export default function DashboardLangkap() {
  ...
  const handleLogout = async () => {
    try {
      // 1. Hapus cache data field agar tidak terjadi throttling/looping
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header">
        <h2 className="field-title">FIELD LANGKAP</h2>
      </div>
