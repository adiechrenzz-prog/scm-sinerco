...
export default function SOPMaintenance() {
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "SOPMaintenance");
    XLSX.writeFile(wb, "SOPMaintenance.xlsx");
  };

  const exportPDF = () => {
    const doc = new jsPDF();
    doc.text("SOPMaintenance", 14, 14);
    autoTable(doc, { head: [["Placeholder"]], body: [["Data"]] });
    doc.save("SOPMaintenance.pdf");
  };

  return (
    <div style={{ padding: 20 }}>
      <h2>SOPMaintenance</h2>
