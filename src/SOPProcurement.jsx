...
export default function SOPProcurement() {
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "SOPProcurement");
    XLSX.writeFile(wb, "SOPProcurement.xlsx");
  };

  const exportPDF = () => {
    const doc = new jsPDF();
    doc.text("SOPProcurement", 14, 14);
    autoTable(doc, { head: [["Placeholder"]], body: [["Data"]] });
    doc.save("SOPProcurement.pdf");
  };

  return (
    <div style={{ padding: 20 }}>
      <h2>SOPProcurement</h2>
