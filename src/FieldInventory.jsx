...
export default function FieldInventory() {
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "FieldInventory");
    XLSX.writeFile(wb, "FieldInventory.xlsx");
  };

  const exportPDF = () => {
    const doc = new jsPDF();
    doc.text("FieldInventory", 14, 14);
    autoTable(doc, { head: [["Placeholder"]], body: [["Data"]] });
    doc.save("FieldInventory.pdf");
  };

  return (
    <div style={{ padding: 20 }}>
      <h2>FieldInventory</h2>
